...
#endif
#ifdef GENERATOR_FILE
extern int mchp_warn_address_attribute_use;
#else
  int x_mchp_warn_address_attribute_use;
#define mchp_warn_address_attribute_use global_options.x_mchp_warn_address_attribute_use
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_MCHP_HI_ADDR_OPT;
#else
  int x_TARGET_MCHP_HI_ADDR_OPT;
#define TARGET_MCHP_HI_ADDR_OPT global_options.x_TARGET_MCHP_HI_ADDR_OPT
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_PRINT_MCHP_SEARCH_DIRS;
#else
  int x_TARGET_PRINT_MCHP_SEARCH_DIRS;
#define TARGET_PRINT_MCHP_SEARCH_DIRS global_options.x_TARGET_PRINT_MCHP_SEARCH_DIRS
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_ALLOW_VOLATILE_LOADS_IN_DELAY_SLOTS;
#else
  int x_TARGET_ALLOW_VOLATILE_LOADS_IN_DELAY_SLOTS;
#define TARGET_ALLOW_VOLATILE_LOADS_IN_DELAY_SLOTS global_options.x_TARGET_ALLOW_VOLATILE_LOADS_IN_DELAY_SLOTS
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mgen_pie_static;
#define x_VAR_mgen_pie_static do_not_use
#endif
#ifndef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_Waddress_attribute_use = 166,          /* -Waddress-attribute-use */
  OPT_Waggregate_return = 167,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 168,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 169,                       /* -Waliasing */
  OPT_Walign_commons = 170,                  /* -Walign-commons */
  OPT_Wall = 171,                            /* -Wall */
  OPT_Wall_deprecation = 172,                /* -Wall-deprecation */
  OPT_Wall_javadoc = 173,                    /* -Wall-javadoc */
  OPT_Wampersand = 174,                      /* -Wampersand */
  OPT_Warray_bounds = 175,                   /* -Warray-bounds */
  ...
  OPT_Wcast_align = 187,                     /* -Wcast-align */
  OPT_Wcast_qual = 188,                      /* -Wcast-qual */
  OPT_Wchar_concat = 189,                    /* -Wchar-concat */
  OPT_Wchar_subscripts = 190,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 191,           /* -Wcharacter-truncation */
  OPT_Wclobbered = 192,                      /* -Wclobbered */
  OPT_Wcomment = 193,                        /* -Wcomment */
  /* OPT_Wcomments = 194, */                 /* -Wcomments */
  OPT_Wcompare_reals = 195,                  /* -Wcompare-reals */
  OPT_Wcondition_assign = 196,               /* -Wcondition-assign */
  OPT_Wconstructor_name = 197,               /* -Wconstructor-name */
  OPT_Wconversion = 198,                     /* -Wconversion */
  OPT_Wconversion_extra = 199,               /* -Wconversion-extra */
  OPT_Wconversion_null = 200,                /* -Wconversion-null */
  OPT_Wcoverage_mismatch = 201,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 202,                            /* -Wcpp */
  OPT_Wctor_dtor_privacy = 203,              /* -Wctor-dtor-privacy */
  ...
  OPT_Wpoison_system_directories = 317,      /* -Wpoison-system-directories */
  ...
  OPT_fclasspath_ = 497,                     /* -fclasspath= */
  OPT_fcoarray_ = 498,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 499,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 500,                         /* -fcommon */
  OPT_fcompare_debug = 501,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 502,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 503,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 504,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 505,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 506,                  /* -fcond-mismatch */
  OPT_fconserve_space = 507,                 /* -fconserve-space */
  OPT_fconserve_stack = 508,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 509,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 510,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 511,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 512,          /* -fconvert=little-endian */
  OPT_fconvert_native = 513,                 /* -fconvert=native */
  OPT_fconvert_swap = 514,                   /* -fconvert=swap */
  OPT_fcprop_registers = 515,                /* -fcprop-registers */
  OPT_fcray_pointer = 516,                   /* -fcray-pointer */
  OPT_fcrossjumping = 517,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 518,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 519, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 520,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 521,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 522,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 523,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 524,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 525,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 526,                       /* -fdbg-cnt= */
  OPT_fdce = 527,                            /* -fdce */
  OPT_fdebug_cpp = 528,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 529,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 530,            /* -fdebug-types-section */
  OPT_fdeduce_init_list = 531,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 532,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 533, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 534,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 535,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 536,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 537,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 538,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 539,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 540,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_caret = 541,         /* -fdiagnostics-show-caret */
  ...
  OPT_fdisable_ = 545,                       /* -fdisable- */
  OPT_fdisable_assertions = 546,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 547,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 548,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 549,         /* -fdollars-in-identifiers */
  OPT_fdse = 550,                            /* -fdse */
  OPT_fdump_ = 551,                          /* -fdump- */
  OPT_fdump_ada_spec = 552,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 553,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 554, */                /* -fdump-core */
  OPT_fdump_final_insns = 555,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 556,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 557,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 558,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 559,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 560,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 561,                /* -fdump-parse-tree */
  OPT_fdump_passes = 562,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 563,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 564,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 565,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 566,                 /* -fearly-inlining */
  OPT_feglibc_ = 567,                        /* -feglibc= */
  OPT_felide_constructors = 568,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 569,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 570, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 571,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 572,        /* -femit-class-debug-always */
  OPT_femit_class_file = 573,                /* -femit-class-file */
  OPT_femit_class_files = 574,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 575,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 576,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 577,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 578,                        /* -fenable- */
  OPT_fenable_assertions = 579,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 580,             /* -fenable-assertions= */
  OPT_fencoding_ = 581,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 582,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 583, */           /* -fenum-int-equiv */
  OPT_fexceptions = 584,                     /* -fexceptions */
  OPT_fexcess_precision_ = 585,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 586,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 587,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 588,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 589,                       /* -fextdirs= */
  OPT_fextended_identifiers = 590,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 591,                /* -fextern-tls-init */
  OPT_fexternal_blas = 592,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 593, */       /* -fexternal-templates */
  OPT_ff2c = 594,                            /* -ff2c */
  OPT_ffast_math = 595,                      /* -ffast-math */
  OPT_ffat_lto_objects = 596,                /* -ffat-lto-objects */
  OPT_ffeature_proxy = 597,                  /* -ffeature-proxy */
  OPT_ffilelist_file = 598,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 599,               /* -ffinite-math-only */
  OPT_ffixed_ = 600,                         /* -ffixed- */
  OPT_ffixed_form = 601,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 602,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 603,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 604,                    /* -ffloat-store */
  OPT_ffor_scope = 605,                      /* -ffor-scope */
  /* OPT_fforce_addr = 606, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 607,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 608,              /* -fforward-propagate */
  OPT_ffp_contract_ = 609,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 610,                      /* -ffpe-trap= */
  OPT_fframe_base_loclist = 611,             /* -fframe-base-loclist */
  OPT_ffree_form = 612,                      /* -ffree-form */
  OPT_ffree_line_length_ = 613,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 614,          /* -ffree-line-length-none */
  OPT_ffreestanding = 615,                   /* -ffreestanding */
  OPT_ffriend_injection = 616,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 617,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 618,                   /* -ffunction-cse */
  OPT_ffunction_sections = 619,              /* -ffunction-sections */
  OPT_fgcse = 620,                           /* -fgcse */
  OPT_fgcse_after_reload = 621,              /* -fgcse-after-reload */
  OPT_fgcse_las = 622,                       /* -fgcse-las */
  OPT_fgcse_lm = 623,                        /* -fgcse-lm */
  OPT_fgcse_sm = 624,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 625,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 626,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 627,                         /* -fgnu-tm */
  OPT_fgnu89_inline = 628,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 629,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 630,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 631,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 632,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 633,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 634,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 635,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 636,                       /* -fgraphite */
  OPT_fgraphite_identity = 637,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 638,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 639, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 640, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 641,           /* -fhash-synchronization */
  /* OPT_fhelp = 642, */                     /* -fhelp */
  /* OPT_fhelp_ = 643, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 644,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 645, */                /* -fhonor-std */
  OPT_fhosted = 646,                         /* -fhosted */
  /* OPT_fhuge_objects = 647, */             /* -fhuge-objects */
  OPT_fident = 648,                          /* -fident */
  OPT_fif_conversion = 649,                  /* -fif-conversion */
  OPT_fif_conversion2 = 650,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 651,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 652,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 653,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 654,             /* -fimplicit-templates */
  OPT_findirect_classes = 655,               /* -findirect-classes */
  OPT_findirect_dispatch = 656,              /* -findirect-dispatch */
  OPT_findirect_inlining = 657,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 658,         /* -finhibit-size-directive */
  OPT_finit_character_ = 659,                /* -finit-character= */
  OPT_finit_integer_ = 660,                  /* -finit-integer= */
  OPT_finit_local_zero = 661,                /* -finit-local-zero */
  OPT_finit_logical_ = 662,                  /* -finit-logical= */
  OPT_finit_real_ = 663,                     /* -finit-real= */
  OPT_finline = 664,                         /* -finline */
  OPT_finline_atomics = 665,                 /* -finline-atomics */
  OPT_finline_functions = 666,               /* -finline-functions */
  OPT_finline_functions_called_once = 667,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 668, */            /* -finline-limit- */
  OPT_finline_limit_ = 669,                  /* -finline-limit= */
  OPT_finline_small_functions = 670,         /* -finline-small-functions */
  OPT_finput_charset_ = 671,                 /* -finput-charset= */
  OPT_finstrument_functions = 672,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 673,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 674,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 675,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 676,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 677,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 678,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 679,                   /* -fipa-cp-clone */
  /* OPT_fipa_matrix_reorg = 680, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 681,                    /* -fipa-profile */
  OPT_fipa_pta = 682,                        /* -fipa-pta */
  OPT_fipa_pure_const = 683,                 /* -fipa-pure-const */
  OPT_fipa_reference = 684,                  /* -fipa-reference */
  OPT_fipa_sra = 685,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 686, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 687,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 688,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 689,              /* -fira-loop-pressure */
  OPT_fira_region_ = 690,                    /* -fira-region= */
  OPT_fira_share_save_slots = 691,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 692,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 693,                   /* -fira-verbose= */
  OPT_fivopts = 694,                         /* -fivopts */
  OPT_fjni = 695,                            /* -fjni */
  OPT_fjump_tables = 696,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 697,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 698,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 699,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 700, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 701,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 702,             /* -fleading-underscore */
  OPT_flicense_me = 703,                     /* -flicense-me */
  OPT_floop_block = 704,                     /* -floop-block */
  /* OPT_floop_flatten = 705, */             /* -floop-flatten */
  OPT_floop_interchange = 706,               /* -floop-interchange */
  OPT_floop_nest_optimize = 707,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 708, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 709,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 710,                /* -floop-strip-mine */
  OPT_flto = 711,                            /* -flto */
  OPT_flto_compression_level_ = 712,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 713,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 714,         /* -flto-partition=balanced */
  OPT_flto_partition_max = 715,              /* -flto-partition=max */
  OPT_flto_partition_none = 716,             /* -flto-partition=none */
  OPT_flto_report = 717,                     /* -flto-report */
  OPT_flto_ = 718,                           /* -flto= */
  OPT_fltrans = 719,                         /* -fltrans */
  OPT_fltrans_output_list_ = 720,            /* -fltrans-output-list= */
  OPT_fmain_ = 721,                          /* -fmain= */
  OPT_fmath_errno = 722,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 723,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 724,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 725,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 726,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 727,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 728,                     /* -fmem-report */
  OPT_fmem_report_wpa = 729,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 730,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 731,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 732,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 733,                /* -fmessage-length= */
  OPT_fmodule_private = 734,                 /* -fmodule-private */
  OPT_fmodulo_sched = 735,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 736,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 737,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 738,                  /* -fms-extensions */
  OPT_fmudflap = 739,                        /* -fmudflap */
  OPT_fmudflapir = 740,                      /* -fmudflapir */
  OPT_fmudflapth = 741,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 742, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 743, */                  /* -fnew-abi */
  OPT_fnext_runtime = 744,                   /* -fnext-runtime */
  OPT_fnil_receivers = 745,                  /* -fnil-receivers */
  OPT_fnofallback = 746,                     /* -fnofallback */
  OPT_fnon_call_exceptions = 747,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 748,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 749, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 750,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 751,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 752,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 753,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 754,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 755,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 756,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 757,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 758,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 759,             /* -fomit-frame-pointer */
  OPT_fopenmp = 760,                         /* -fopenmp */
  OPT_foperator_names = 761,                 /* -foperator-names */
  OPT_fopt_info = 762,                       /* -fopt-info */
  OPT_fopt_info_ = 763,                      /* -fopt-info- */
  OPT_foptimize_register_move = 764,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 765,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 766,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 767,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 768, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 769,              /* -foutput-class-dir= */
  OPT_fpack_derived = 770,                   /* -fpack-derived */
  OPT_fpack_struct = 771,                    /* -fpack-struct */
  OPT_fpack_struct_ = 772,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 773,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 774,              /* -fpcc-struct-return */
  OPT_fpch_deps = 775,                       /* -fpch-deps */
  OPT_fpch_preprocess = 776,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 777,                     /* -fpeel-loops */
  OPT_fpeephole = 778,                       /* -fpeephole */
  OPT_fpeephole2 = 779,                      /* -fpeephole2 */
  OPT_fpermissive = 780,                     /* -fpermissive */
  OPT_fpic = 781,                            /* -fpic */
  OPT_fpie = 782,                            /* -fpie */
  OPT_fplan9_extensions = 783,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 784,                    /* -fplugin-arg- */
  OPT_fplugin_ = 785,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 786,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 787,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 788,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 789,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 790,                   /* -fpreprocessed */
  OPT_fpretty_templates = 791,               /* -fpretty-templates */
  OPT_fprofile = 792,                        /* -fprofile */
  OPT_fprofile_arcs = 793,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 794,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 795,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 796,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 797,              /* -fprofile-generate= */
  OPT_fprofile_report = 798,                 /* -fprofile-report */
  OPT_fprofile_use = 799,                    /* -fprofile-use */
  OPT_fprofile_use_ = 800,                   /* -fprofile-use= */
  OPT_fprofile_values = 801,                 /* -fprofile-values */
  OPT_fprotect_parens = 802,                 /* -fprotect-parens */
  OPT_frandom_seed = 803,                    /* -frandom-seed */
  OPT_frandom_seed_ = 804,                   /* -frandom-seed= */
  OPT_frange_check = 805,                    /* -frange-check */
  OPT_freal_4_real_10 = 806,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 807,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 808,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 809,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 810,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 811,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 812,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 813,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 814,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 815,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 816,                /* -frecord-marker=8 */
  OPT_frecursive = 817,                      /* -frecursive */
  OPT_freduced_reflection = 818,             /* -freduced-reflection */
  OPT_free = 819,                            /* -free */
  OPT_freg_struct_return = 820,              /* -freg-struct-return */
  OPT_fregmove = 821,                        /* -fregmove */
  OPT_frename_registers = 822,               /* -frename-registers */
  OPT_freorder_blocks = 823,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 824,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 825,              /* -freorder-functions */
  OPT_frepack_arrays = 826,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 827,           /* -freplace-objc-classes */
  OPT_frepo = 828,                           /* -frepo */
  OPT_frequire_return_statement = 829,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 830,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 831, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 832,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 833,                    /* -fresolution= */
  OPT_frounding_math = 834,                  /* -frounding-math */
  OPT_frtti = 835,                           /* -frtti */
  OPT_fsanitize_address = 836,               /* -fsanitize=address */
  OPT_fsanitize_thread = 837,                /* -fsanitize=thread */
  OPT_fsaw_java_file = 838,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 839,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 840,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 841,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 842,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 843,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 844,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 845,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 846,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 847,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 848,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 849,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 850,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 851,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 852,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 853,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 854,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 855,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 856, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 857,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 858,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 859,              /* -fsecond-underscore */
  OPT_fsection_anchors = 860,                /* -fsection-anchors */
  /* OPT_fsee = 861, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 862,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 863,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 864, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 865,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 866,          /* -fselective-scheduling2 */
  OPT_fshort_double = 867,                   /* -fshort-double */
  OPT_fshort_enums = 868,                    /* -fshort-enums */
  OPT_fshort_wchar = 869,                    /* -fshort-wchar */
  OPT_fshow_column = 870,                    /* -fshow-column */
  OPT_fshrink_wrap = 871,                    /* -fshrink-wrap */
  OPT_fsign_zero = 872,                      /* -fsign-zero */
  OPT_fsignaling_nans = 873,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 874,               /* -fsigned-bitfields */
  OPT_fsigned_char = 875,                    /* -fsigned-char */
  OPT_fsigned_zeros = 876,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 877,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 878,               /* -fsource-filename= */
  OPT_fsource_ = 879,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 880,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 881,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 882,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 883, */                 /* -fsquangle */
  OPT_fstack_arrays = 884,                   /* -fstack-arrays */
  /* OPT_fstack_check = 885, */              /* -fstack-check */
  OPT_fstack_check_ = 886,                   /* -fstack-check= */
  OPT_fstack_limit = 887,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 888,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 889,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 890,                /* -fstack-protector */
  OPT_fstack_protector_all = 891,            /* -fstack-protector-all */
  OPT_fstack_reuse_ = 892,                   /* -fstack-reuse= */
  OPT_fstack_usage = 893,                    /* -fstack-usage */
  OPT_fstats = 894,                          /* -fstats */
  OPT_fstore_check = 895,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 896, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 897,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 898,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 899,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 900, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 901,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 902,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 903,                    /* -fsyntax-only */
  OPT_ftabstop_ = 904,                       /* -ftabstop= */
  /* OPT_ftarget_help = 905, */              /* -ftarget-help */
  OPT_ftarget_ = 906,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 907,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 908, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 909,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 910,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 911, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 912,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 913,             /* -fthreadsafe-statics */
  OPT_ftime_report = 914,                    /* -ftime-report */
  OPT_ftls_model_ = 915,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 916,               /* -ftoplevel-reorder */
  OPT_ftracer = 917,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 918,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 919,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 920,                  /* -ftrapping-math */
  OPT_ftrapv = 921,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 922,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 923,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 924,                       /* -ftree-ccp */
  OPT_ftree_ch = 925,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 926,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 927,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 928,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 929,                /* -ftree-copyrename */
  OPT_ftree_cselim = 930,                    /* -ftree-cselim */
  OPT_ftree_dce = 931,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 932,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 933,                       /* -ftree-dse */
  OPT_ftree_forwprop = 934,                  /* -ftree-forwprop */
  OPT_ftree_fre = 935,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 936,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 937,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 938,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 939,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 940,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 941,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 942, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 943,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 944,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 945,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 946,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 947,                   /* -ftree-phiprop */
  OPT_ftree_pre = 948,                       /* -ftree-pre */
  OPT_ftree_pta = 949,                       /* -ftree-pta */
  OPT_ftree_reassoc = 950,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 951, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 952,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 953,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 954,             /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 955,                      /* -ftree-slsr */
  OPT_ftree_sra = 956,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 957, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 958, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 959,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 960,                /* -ftree-tail-merge */
  OPT_ftree_ter = 961,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 962,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 963,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 964,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 965,                       /* -ftree-vrp */
  OPT_funderscoring = 966,                   /* -funderscoring */
  OPT_funit_at_a_time = 967,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 968,               /* -funroll-all-loops */
  OPT_funroll_loops = 969,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 970,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 971,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 972,             /* -funsigned-bitfields */
  OPT_funsigned_char = 973,                  /* -funsigned-char */
  OPT_funswitch_loops = 974,                 /* -funswitch-loops */
  OPT_funwind_tables = 975,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 976,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 977,                   /* -fuse-boehm-gc */
  OPT_fuse_caller_save = 978,                /* -fuse-caller-save */
  OPT_fuse_cxa_atexit = 979,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 980,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 981,          /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 982,                     /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 983,                    /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 984,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 985,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 986,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 987,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 988,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 989, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 990,                /* -fvect-cost-model */
  OPT_fverbose_asm = 991,                    /* -fverbose-asm */
  /* OPT_fversion = 992, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 993,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 994,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 995,                    /* -fvisibility= */
  OPT_fvpt = 996,                            /* -fvpt */
  /* OPT_fvtable_gc = 997, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 998, */            /* -fvtable-thunks */
  OPT_fweak = 999,                           /* -fweak */
  OPT_fweb = 1000,                           /* -fweb */
  OPT_fwhole_file = 1001,                    /* -fwhole-file */
  OPT_fwhole_program = 1002,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1003,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1004,             /* -fworking-directory */
  OPT_fwpa = 1005,                           /* -fwpa */
  OPT_fwrapv = 1006,                         /* -fwrapv */
  /* OPT_fxref = 1007, */                    /* -fxref */
  /* OPT_fzee = 1008, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1009,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1010,                     /* -fzero-link */
  OPT_g = 1011,                              /* -g */
  OPT_gant = 1012,                           /* -gant */
  OPT_gcoff = 1013,                          /* -gcoff */
  OPT_gdwarf_ = 1014,                        /* -gdwarf- */
  OPT_gen_decls = 1015,                      /* -gen-decls */
  OPT_ggdb = 1016,                           /* -ggdb */
  OPT_gnat = 1017,                           /* -gnat */
  OPT_gnatO = 1018,                          /* -gnatO */
  OPT_gno_pubnames = 1019,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1020,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1021,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1022,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1023,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1024,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1025,                   /* -gsplit-dwarf */
  OPT_gstabs = 1026,                         /* -gstabs */
  OPT_gstabs_ = 1027,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1028,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1029,                        /* -gtoggle */
  OPT_gvms = 1030,                           /* -gvms */
  OPT_gxcoff = 1031,                         /* -gxcoff */
  OPT_gxcoff_ = 1032,                        /* -gxcoff+ */
  OPT_h = 1033,                              /* -h */
  OPT_idirafter = 1034,                      /* -idirafter */
  OPT_imacros = 1035,                        /* -imacros */
  OPT_imultiarch = 1036,                     /* -imultiarch */
  OPT_imultilib = 1037,                      /* -imultilib */
  OPT_include = 1038,                        /* -include */
  OPT_iplugindir_ = 1039,                    /* -iplugindir= */
  OPT_iprefix = 1040,                        /* -iprefix */
  OPT_iquote = 1041,                         /* -iquote */
  OPT_isysroot = 1042,                       /* -isysroot */
  OPT_isystem = 1043,                        /* -isystem */
  OPT_iwithprefix = 1044,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1045,              /* -iwithprefixbefore */
  OPT_k8 = 1046,                             /* -k8 */
  OPT_l = 1047,                              /* -l */
  OPT_lang_asm = 1048,                       /* -lang-asm */
  OPT_mabi_ = 1049,                          /* -mabi= */
  OPT_mabicalls = 1050,                      /* -mabicalls */
  /* OPT_mabs2008 = 1051, */                 /* -mabs2008 */
  OPT_mabs_ = 1052,                          /* -mabs= */
  OPT_mappio_debug = 1053,                   /* -mappio-debug */
  OPT_march_ = 1054,                         /* -march= */
  OPT_mbranch_cost_ = 1055,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1056,                 /* -mbranch-likely */
  OPT_mcci = 1057,                           /* -mcci */
  OPT_mcheck_zero_division = 1058,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1059,                /* -mcode-readable= */
  /* OPT_mcode_xonly = 1060, */              /* -mcode-xonly */
  OPT_mconfig_data_dir_ = 1061,              /* -mconfig-data-dir= */
  OPT_mdebug = 1062,                         /* -mdebug */
  OPT_mdebugd = 1063,                        /* -mdebugd */
  OPT_mdebugdmips = 1064,                    /* -mdebugdmips */
  OPT_mdebugger = 1065,                      /* -mdebugger */
  OPT_mdebugmips = 1066,                     /* -mdebugmips */
  OPT_mdivide_breaks = 1067,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1068,                  /* -mdivide-traps */
  OPT_mdmx = 1069,                           /* -mdmx */
  OPT_mdouble_float = 1070,                  /* -mdouble-float */
  OPT_mdsp = 1071,                           /* -mdsp */
  OPT_mdspr2 = 1072,                         /* -mdspr2 */
  OPT_meb = 1073,                            /* -meb */
  OPT_mel = 1074,                            /* -mel */
  OPT_membedded_data = 1075,                 /* -membedded-data */
  OPT_meva = 1076,                           /* -meva */
  OPT_mexplicit_relocs = 1077,               /* -mexplicit-relocs */
  OPT_mext_ = 1078,                          /* -mext= */
  OPT_mextern_sdata = 1079,                  /* -mextern-sdata */
  OPT_mfill_ = 1080,                         /* -mfill= */
  OPT_mfix_24k = 1081,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1082,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1083,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1084,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1085,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1086,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1087,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1088,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1089,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1090,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1091,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1092,                 /* -mfp-exceptions */
  OPT_mfp32 = 1093,                          /* -mfp32 */
  OPT_mfp64 = 1094,                          /* -mfp64 */
  OPT_mframe_header_opt = 1095,              /* -mframe-header-opt */
  OPT_mfused_madd = 1096,                    /* -mfused-madd */
  OPT_mgen_pie_static = 1097,                /* -mgen-pie-static */
  OPT_mgp32 = 1098,                          /* -mgp32 */
  OPT_mgp64 = 1099,                          /* -mgp64 */
  OPT_mgpopt = 1100,                         /* -mgpopt */
  OPT_mhard_float = 1101,                    /* -mhard-float */
  OPT_mhi_addr_opt = 1102,                   /* -mhi-addr-opt */
  OPT_mimadd = 1103,                         /* -mimadd */
  OPT_minterlink_compressed = 1104,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1105,              /* -minterlink-mips16 */
  OPT_mips = 1106,                           /* -mips */
  OPT_mips16 = 1107,                         /* -mips16 */
  OPT_mips16e = 1108,                        /* -mips16e */
  OPT_mips3d = 1109,                         /* -mips3d */
  OPT_mit_ = 1110,                           /* -mit= */
  OPT_mjals = 1111,                          /* -mjals */
  OPT_mlicense_warning = 1112,               /* -mlicense-warning */
  OPT_mllsc = 1113,                          /* -mllsc */
  OPT_mlocal_sdata = 1114,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1115,                    /* -mlong-calls */
  OPT_mlong32 = 1116,                        /* -mlong32 */
  OPT_mlong64 = 1117,                        /* -mlong64 */
  OPT_mmad = 1118,                           /* -mmad */
  OPT_mmcount_ra_address = 1119,             /* -mmcount-ra-address */
  OPT_mmcu = 1120,                           /* -mmcu */
  OPT_mmemcpy = 1121,                        /* -mmemcpy */
  OPT_mmemorysummary_ = 1122,                /* -mmemorysummary= */
  OPT_mmicromips = 1123,                     /* -mmicromips */
  OPT_mmips_tfile = 1124,                    /* -mmips-tfile */
  OPT_mmips16_exceptions = 1125,             /* -mmips16-exceptions */
  OPT_mmt = 1126,                            /* -mmt */
  /* OPT_mnan2008 = 1127, */                 /* -mnan2008 */
  OPT_mnan_ = 1128,                          /* -mnan= */
  /* OPT_mno_data_in_code = 1129, */         /* -mno-data-in-code */
  OPT_mno_default_isr_vectors = 1130,        /* -mno-default-isr-vectors */
  OPT_mno_dspr2 = 1131,                      /* -mno-dspr2 */
  OPT_mno_fallback = 1132,                   /* -mno-fallback */
  OPT_mno_float = 1133,                      /* -mno-float */
  OPT_mno_flush_func = 1134,                 /* -mno-flush-func */
  OPT_mno_mcu = 1135,                        /* -mno-mcu */
  OPT_mno_mdmx = 1136,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1137,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1138,                     /* -mno-mips3d */
  OPT_mno_mpdebug_lib = 1139,                /* -mno-mpdebug-lib */
  OPT_mpaired_single = 1140,                 /* -mpaired-single */
  OPT_mperipheral_libs = 1141,               /* -mperipheral-libs */
  OPT_mpic32mmlibs = 1142,                   /* -mpic32mmlibs */
  OPT_mpic32mxlibs = 1143,                   /* -mpic32mxlibs */
  OPT_mpic32mzlibs = 1144,                   /* -mpic32mzlibs */
  OPT_mplt = 1145,                           /* -mplt */
  OPT_mprint_builtins = 1146,                /* -mprint-builtins */
  OPT_mprint_mchp_search_dirs = 1147,        /* -mprint-mchp-search-dirs */
  OPT_mprocessor_ = 1148,                    /* -mprocessor= */
  OPT_mr10k_cache_barrier_ = 1149,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1150,               /* -mrelax-pic-calls */
  OPT_mrelaxed_math = 1151,                  /* -mrelaxed-math */
  OPT_mreserve_ = 1152,                      /* -mreserve= */
  OPT_mresource_ = 1153,                     /* -mresource= */
  OPT_mshared = 1154,                        /* -mshared */
  OPT_msingle_float = 1155,                  /* -msingle-float */
  OPT_msmall_isa = 1156,                     /* -msmall-isa */
  OPT_msmart_io = 1157,                      /* -msmart-io */
  OPT_msmart_io_ = 1158,                     /* -msmart-io= */
  OPT_msmartmips = 1159,                     /* -msmartmips */
  OPT_msoft_float = 1160,                    /* -msoft-float */
  OPT_msplit_addresses = 1161,               /* -msplit-addresses */
  OPT_msym32 = 1162,                         /* -msym32 */
  OPT_msynci = 1163,                         /* -msynci */
  OPT_mtext_ = 1164,                         /* -mtext= */
  OPT_mtune_ = 1165,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1166,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1167,                          /* -mvirt */
  OPT_mvolatile_in_delay_slot = 1168,        /* -mvolatile-in-delay-slot */
  OPT_mvr4130_align = 1169,                  /* -mvr4130-align */
  OPT_mxc32cpp_lib = 1170,                   /* -mxc32cpp-lib */
  OPT_mxgot = 1171,                          /* -mxgot */
  OPT_n = 1172,                              /* -n */
  OPT_no_canonical_prefixes = 1173,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1174,              /* -no-integrated-cpp */
  OPT_noasmopt = 1175,                       /* -noasmopt */
  OPT_nocpp = 1176,                          /* -nocpp */
  OPT_nodefaultlibs = 1177,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1178,                   /* -nostartfiles */
  OPT_nostdinc = 1179,                       /* -nostdinc */
  OPT_nostdinc__ = 1180,                     /* -nostdinc++ */
  OPT_nostdlib = 1181,                       /* -nostdlib */
  OPT_o = 1182,                              /* -o */
  OPT_p = 1183,                              /* -p */
  OPT_pass_exit_codes = 1184,                /* -pass-exit-codes */
  /* OPT_pedantic = 1185, */                 /* -pedantic */
  OPT_pedantic_errors = 1186,                /* -pedantic-errors */
  OPT_pg = 1187,                             /* -pg */
  OPT_pie = 1188,                            /* -pie */
  OPT_pipe = 1189,                           /* -pipe */
  OPT_print_file_name_ = 1190,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1191,         /* -print-libgcc-file-name */
  /* OPT_print_mchp_search_dirs = 1192, */   /* -print-mchp-search-dirs */
  OPT_print_multi_directory = 1193,          /* -print-multi-directory */
  OPT_print_multi_lib = 1194,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1195,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1196,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1197,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1198,               /* -print-prog-name= */
  OPT_print_search_dirs = 1199,              /* -print-search-dirs */
  OPT_print_sysroot = 1200,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1201,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1202,                          /* -quiet */
  OPT_r = 1203,                              /* -r */
  OPT_remap = 1204,                          /* -remap */
  OPT_s = 1205,                              /* -s */
  OPT_s_bc_abi = 1206,                       /* -s-bc-abi */
  OPT_save_temps = 1207,                     /* -save-temps */
  OPT_save_temps_ = 1208,                    /* -save-temps= */
  OPT_shared = 1209,                         /* -shared */
  OPT_shared_libgcc = 1210,                  /* -shared-libgcc */
  /* OPT_specs = 1211, */                    /* -specs */
  OPT_specs_ = 1212,                         /* -specs= */
  OPT_static = 1213,                         /* -static */
  OPT_static_libasan = 1214,                 /* -static-libasan */
  OPT_static_libgcc = 1215,                  /* -static-libgcc */
  OPT_static_libgcj = 1216,                  /* -static-libgcj */
  OPT_static_libgfortran = 1217,             /* -static-libgfortran */
  OPT_static_libgo = 1218,                   /* -static-libgo */
  OPT_static_libstdc__ = 1219,               /* -static-libstdc++ */
  OPT_static_libtsan = 1220,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1221, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1222, */                /* -std=c++0x */
  OPT_std_c__11 = 1223,                      /* -std=c++11 */
  OPT_std_c__1y = 1224,                      /* -std=c++1y */
  OPT_std_c__98 = 1225,                      /* -std=c++98 */
  OPT_std_c11 = 1226,                        /* -std=c11 */
  /* OPT_std_c1x = 1227, */                  /* -std=c1x */
  /* OPT_std_c89 = 1228, */                  /* -std=c89 */
  OPT_std_c90 = 1229,                        /* -std=c90 */
  OPT_std_c99 = 1230,                        /* -std=c99 */
  /* OPT_std_c9x = 1231, */                  /* -std=c9x */
  OPT_std_f2003 = 1232,                      /* -std=f2003 */
  OPT_std_f2008 = 1233,                      /* -std=f2008 */
  OPT_std_f2008ts = 1234,                    /* -std=f2008ts */
  OPT_std_f95 = 1235,                        /* -std=f95 */
  OPT_std_gnu = 1236,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1237, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1238, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1239,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1240,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1241,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1242,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1243, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1244, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1245,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1246,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1247, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1248, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1249,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1250, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1251, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1252, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1253,                     /* -std=legacy */
  OPT_symbolic = 1254,                       /* -symbolic */
  OPT_t = 1255,                              /* -t */
  OPT_time = 1256,                           /* -time */
  OPT_time_ = 1257,                          /* -time= */
  OPT_traditional = 1258,                    /* -traditional */
  OPT_traditional_cpp = 1259,                /* -traditional-cpp */
  OPT_trigraphs = 1260,                      /* -trigraphs */
  OPT_u = 1261,                              /* -u */
  OPT_undef = 1262,                          /* -undef */
  OPT_v = 1263,                              /* -v */
  OPT_version = 1264,                        /* -version */
  OPT_w = 1265,                              /* -w */
  OPT_wrapper = 1266,                        /* -wrapper */
  OPT_x = 1267,                              /* -x */
  OPT_z = 1268,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
